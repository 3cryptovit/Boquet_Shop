...
function Favorites() {
  const { favorites, removeFromFavorites, fetchFavorites, isLoading } = useFavoritesStore();
  ...
  return (
    <div style={styles.container}>
      ...
      {isLoading ? (
        <div style={styles.loading}>Загрузка избранного...</div>
      ) : favorites.length === 0 ? (
        ...
        <>
          ...
          <div style={styles.grid}>
            {favorites.map((bouquet) => {
              // Определяем ID букета (может быть как bouquet.id, так и bouquet.bouquet_id)
              const bouquetId = bouquet.id || bouquet.bouquet_id;

              return (
                <div key={bouquetId} style={styles.card}>
                  <div
                    style={{
                      ...styles.cardImage,
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => removeFromFavorites(bouquetId)}
                    >
                      ×
                    </button>
                  </div>
                  <div style={styles.cardContent}>
                    ...
                    <div style={styles.cardActions}>
                      ...
                      <button
                        ...
                        onClick={() => navigate(`/bouquet/${bouquetId}`)}
                      >
                        Подробнее
                      </button>
                    </div>
